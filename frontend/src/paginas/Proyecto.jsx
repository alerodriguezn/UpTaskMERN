            ...
            <>
                ...
                {admin && (
                    <button
                        ...
                        type="button"
                        className="mt-5 flex gap-2 text-sm px-5 items-center justify-center py-3 w-full md:w-auto rounded-lg uppercase font-bold bg-sky-400 text-white text-center"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
